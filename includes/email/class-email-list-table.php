 ...
 * WP_List_Table contains most of the framework for genedescription the table, but we
...
class TT_Example_List_Table extends WP_List_Table {
	...
	protected function column_name( $item ) {
		...
		$actions['edit'] = sprintf(
			'<a href="%1$s">%2$s</a>',
			esc_url( wp_nonce_url( add_query_arg( $edit_query_args, rawurlencode( 'admin.php' ) ), 'editmovie_' . $item['ID'] ) ),
	...
	/**
	 * Get an associative array ( option_name => option_name ) with the list
